...
import { useGetTitleAnalyses, getGetTitleAnalysesQueryKey, useGetScriptAnalyses, getGetScriptAnalysesQueryKey, useGetGeneratedScripts, getGetGeneratedScriptsQueryKey } from "@workspace/api-client-react";
...
export default function History() {
  ...
  const { data: genData, isLoading: genLoading } = useGetGeneratedScripts({
    query: { queryKey: getGetGeneratedScriptsQueryKey() },
  });
